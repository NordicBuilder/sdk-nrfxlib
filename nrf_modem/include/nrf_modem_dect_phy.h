...
enum nrf_modem_dect_phy_event_id {
	...
	/**
	 * @brief Event to receive RSSI measurements.
	 */
	...
	/**
	 * @brief Event to retrieve modem time.
	 */
	NRF_MODEM_DECT_PHY_EVT_TIME,
	/**
	 * @brief Event to retrieve capabilities.
	 */
	NRF_MODEM_DECT_PHY_EVT_CAPABILITY,
	/**
	 * @brief Event to retrieve band information.
	 */
	NRF_MODEM_DECT_PHY_EVT_BANDS,
	/**
	 * @brief Event to retrieve latency information.
	 */
...
/**
 * @brief De-initialize the DECT PHY interface.
 *
 * De-initialize the DECT PHY interface and all associated hardware resources.
 ...
 *
 * @note
 * Before activation, the DECT PHY software stack must be configured using
 ...
 *
 * @note
 * This operation can only be performed when the PHY stack is initialized and deactivated.
 *
 * This operation is performed asynchronously.
...
/**
 * @brief Query band information from DECT PHY.
 *
 * This operation is performed asynchronously.
...
/**
 * @brief Query latency information from DECT PHY.
 *
 * This operation is performed asynchronously.
